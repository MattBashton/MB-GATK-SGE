...
echo "Running GATK exome pipeline"
echo ""
tput sgr0
...
#### Calling
tput bold
echo " * 9 Haplotype Caller jobs submitted"
tput sgr0
...
tput bold
echo " * 10 GenotypeGVFs submitted"
tput sgr0
...
tput bold
echo " * 11 VQSR model building jobs submitted"
tput sgr0
...
tput bold
echo " * 12 Apply VQSR jobs submitted"
tput sgr0
...
tput bold
echo " * 13 Filter VCF jobs submitted"
tput sgr0
...
tput bold
echo " * 14 Split VCF jobs submitted"
tput sgr0
...
tput bold
echo " * 15 Ensembl VEP jobs submitted"
tput sgr0
