...
-o $TMPDIR/$B_NAME.UG_snps_ccQ10.vcf \
--log_to_file $B_NAME.UG_snps_ccQ10.log

echo "Copying output TMPDIR/$B_NAME.vcf* to $PWD"
/usr/bin/time --verbose cp -v $TMPDIR/$B_NAME.UG_snps_ccQ10.vcf $PWD
/usr/bin/time --verbose cp -v $TMPDIR/$B_NAME.UG_snps_ccQ10.vcf.idx $PWD
